...
public static function CreateConf($api_endpoint="",$licence_username="",$licence_password="",$licence_secret_key="",$application_token="",$wemalo_token="")
 {
   ...
   $res=str_replace("###LICENCE_SECRET_KEY###",$licence_secret_key,$res);
