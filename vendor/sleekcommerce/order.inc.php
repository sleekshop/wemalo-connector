...
private static function get_order_details($json="")
{
  ...
  $result["delivery_country_code"]=(string)$json->delivery_country_code;
  ...
  $result["invoice_country_code"]=(string)$json->invoice_country_code;
  ...
  */
  public static function SearchOrders($constraint=array(),$left_limit=0,$right_limit=0,$order_columns=array(),$order_type="ASC",$language=DEFAULT_LANGUAGE)
  {
    ...
    foreach($json->result as $order)
    {
      ...
      $piece["delivery_country_code"]=(string)$order->order_delivery_country_code;
      ...
      $piece["invoice_country_code"]=(string)$order->order_invoice_country_code;
